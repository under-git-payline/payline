...
export default function Hero({ data }: HeroProps) {
  ...
  return (
    <div className={`relative container ${hasRightSide ? 'flex flex-col-reverse lg:flex-row items-center justify-between' : 'flex flex-col items-center justify-center text-center'} gap-10 pt-10 px-10 lg:py-10 bg-brand-gradient text-white rounded-4xl ${data?.addCalculator ? 'mb-50' : 'mb-10'}`}>
      <div className={`flex flex-col gap-10 ${hasRightSide ? 'lg:max-w-1/2' : 'max-w-3xl w-full items-center text-center'} pb-10 lg:p-10`}>
      ...
      {shouldShowForm ? (
        <div className="w-full lg:w-auto" ref={formContainerRef}>
